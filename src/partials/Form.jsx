...
function Form() {
  return (
    <section className="relative">
      <div className="max-w-6xl mx-auto pt-40 sm:pt-20 px-4 sm:px-6">
        <div className="pb-96 md:pb-70">

          {/* CTA box */}
          <div className="relative bg-gray-900 rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl overflow-hidden aos-init aos-animate" data-aos="zoom-y-out">
